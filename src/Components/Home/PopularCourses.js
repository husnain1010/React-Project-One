...
function PopularCourses() {
  ...
  return (
    ...
    <Container className="container">
      ...
      <Box align="center" sx={{ pt: {lg:5 ,xs:2,} }}>
        ...
        >
          ...
          readable content of a page when looking at its layout.
           ...
           <Box >
           <Grid container spacing={3} sx={{ pt: {lg:7,md:4 ,xs:2}, display:"flex" ,  }}>
      
       
        <Grid className="sumb" item xs={12} md={12} lg={6} sx={{ display: "flex", }}>
          <Box>
          ...
          <Box className="border">
            <Typography
              variant="h1"
              className="pop headings"
            >
             Fundamental Of UI/UX Design
            </Typography>
            <Typography
              className="pop para" variant="h6"
              
            >
             Some quick example text to build on the card title and make up the bulk of the card.
            </Typography>
            <Typography variant="h6"   className="price" >Price 20$</Typography>
          </Box>
        </Grid>
        <Grid className="sumb" item xs={12} md={12} lg={6} sx={{ display: "flex", }}>
          <Box>
        ...
        <Grid className="sumb card-set1" item xs={12} md={12} lg={6} sx={{ display: "flex", }}>
          <Box>
        ...
        <Grid className="sumb card-set1" item xs={12} md={12} lg={6} sx={{ display: "flex", }}>
          ...
          <Box sx={{pt:6.5}}>
            <Typography
              className="pop para some" variant="h6"
      ...
      {state && (<Grid container spacing={3} className="cardtop"  sx={{ pt: {lg:7,md:4 ,xs:2}, display:"flex"  }}>
      <Grid className="sumb" item xs={12} md={12} lg={6} sx={{ display: "flex", }}>
          <Box>
            <img src={lapt} alt="images" className="img-fluid setimgsix" />
          </Box>
      ...
      <Button variant="contained" color="primary" className="More-Courses-btn" >
      See More Courses
      </Button>
      <Button onClick={()=>setstate(!state)} variant="contained" color="primary" className="view_all" sx={{mt:5}}>
