    ...
    <Container className="container" sx={{ mt: { lg: 20, xs: 5 } }}>
      ...
      <Box>
        ...
        >
          ...
          <br></br> readable content of a page when looking at its layout.
        </Typography>
      </Box>
      ...
      <Box>
        ...
        <Box className="viewallbtn" sx={{ mt: 6 }}>
          <Button
            variant="contained"
            className="pop viewbgcolor"
            sx={{ px: 4, py: 1.5, fontSize: 20, fontWeight: 600 }}
          >
            View All
          </Button>
        </Box>
