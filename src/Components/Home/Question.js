        ...
        <Grid item xs={12}>
          <Box className="hu" sx={{ mt: {lg:10,md:10, sm:8, xs:6} }}>
            <Typography
              variant="h3"
              className="pop"
              sx={{ color: "#1D1D1D", fontSize: {lg:45,md:45, sm:45, xs:20}, fontWeight: 600 }}
            >
            ...
            <Typography
              variant="h6"
              className="pop"
              sx={{ color: "#777777", fontSize: {lg:16,md:16, sm:16, xs:14}, fontWeight: 400, my: {lg:8,md:6, sm:4, xs:3} }}
            >
            ...
            {question.map((values)=>(
              <Accordion className="hum" sx={{mt:2}}>
                <AccordionSummary className="according1"
